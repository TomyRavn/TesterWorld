    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/template/editor/photo_uploader/popup/file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	        ...
 	        sCallback : '/resources/module/SE2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
