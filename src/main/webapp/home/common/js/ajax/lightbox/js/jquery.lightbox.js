...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			compressed: {
				js: {
					lightbox:	'/js/ajax/lightbox/js/jquery.lightbox.min.js',
					colorBlend:	'/js/ajax/lightbox/js/jquery.color.min.js'
				},
				css: {
					lightbox:	'/js/ajax/lightbox/css/jquery.lightbox.css'
				}
			},
			uncompressed: {
				js: {
					lightbox:	'/js/ajax/lightbox/js/jquery.lightbox.js',
					colorBlend:	'/js/ajax/lightbox/js/jquery.color.js'
				},
				css: {
					lightbox:	'/js/ajax/lightbox/css/jquery.lightbox.css'
				}
			...
			images: {
				prev:		'/js/ajax/lightbox/images/prev.gif',
				next:		'/js/ajax/lightbox/images/next.gif',
				blank:		'/js/ajax/lightbox/images/blank.gif',
				loading:	'/js/ajax/lightbox/images/loading.gif'
			}
		},
		...
		domReady: function ( )
		{
			...
			$('body').append('<div id="lightbox-overlay"><div id="lightbox-overlay-text">'+(this.show_linkback?'<p><span id="lightbox-overlay-text-about"><a href="#" title="'+this.text.about.title+'">'+this.text.about.text+'</a></span></p><p>&nbsp;</p>':'')+'<p><span id="lightbox-overlay-text-close">'+this.text.help.close+'</span><br/>&nbsp;<span id="lightbox-overlay-text-interact">'+this.text.help.interact+'</span></p></div></div><div id="lightbox"><div id="lightbox-imageBox"><div id="lightbox-imageContainer"><img id="lightbox-image" alt="lightbox-image" /><div id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' + this.files.images.loading + '" alt="' + this.files.images.loading + '" /></a></div></div></div><div id="lightbox-infoBox"><div id="lightbox-infoContainer"><div id="lightbox-infoHeader"><span id="lightbox-caption">'+(this.download_link ? '<a href="#" title="' + this.text.download + '" id="lightbox-caption-title"></a>' : '<span id="lightbox-caption-title"></span>')+'<span id="lightbox-caption-seperator"></span><span id="lightbox-caption-description"></span></span></div><div id="lightbox-infoFooter"><span id="lightbox-currentNumber"></span><span id="lightbox-close"><a href="#" id="lightbox-close-button" title="'+this.text.closeInfo+'">' + this.text.close + '</a></span></div><div id="lightbox-infoContainer-clear"></div></div></div></div>');
		...
		showImage: function ( image, step )
		{
			...
			switch ( step )
			{
				...
				case 2:
					...
					$('#lightbox-image').attr('alt', image.title);
