function imgLayer(param,btn,target,fadein,itemsURL){
	var param = $(param);
	...
	btn.click(function(){
		...
		layer.html("<div id='exit'><strong>"+view_title+"</strong><span>"+view_date+"</span><a title='현재 레이어 닫기' href='#descpt'><img src='/js/prdnt/viewer_2/exit.png' alt='' /></a><div class='clear'></div></div><div class='thumb_wrap'><img class='thumb' width='617' height='465' src='"+src+"' alt='' /></div>");
